...
function draw() {
 ...
 var Board1c=Matter.SAT.collides(board1.body,playerArrows[i].body)
 var Board2c=Matter.SAT.collides(board2.body,playerArrows[i].body)
 if(Board1c.collided||Board2c.collided){
   console.log("success")
 }
  // Title
  fill("#FFFF");
